...
char** message;
SquareType** grid; mutex gridLock;

mutex outputMutex; string outFilePath = "robotSimulOut.txt";

vector<unsigned int> doorAssignments;
...
int main(const int argc, char** argv)
{
	...
	// Application's start time, for display
...
void moveRobot(GridPosition* robotPos, const Direction direction)
{
	...
	gridLock.lock(); // ENTERING CRITICAL SECTION: Lock grid
	...
	gridLock.unlock(); // LEAVING CRITICAL SECTION: Unlock grid
}
